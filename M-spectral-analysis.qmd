...
This chapter provides some guidance on spectral analysis, which will allow to understand the spectral analysis tools available in JDemetra+ [Graphical User Interface](#t-GUI-tstools-spectral).
