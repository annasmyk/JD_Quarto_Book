...
\[3\]<!---[7.100]--> can be presented as equation
...
the modulus of $a_{j}$, then \[3\] can be rewritten in the form:
...
$j^{\text{th}}$ harmonic to the variance and \[14\] shows then how the
