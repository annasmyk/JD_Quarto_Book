# Plug-ins for JDemetra+ {.unnumbered #t-plug-ins}
...
This list is displayed in the *Installed* panel. This panel is available from the *Plugin* functionality and it is activated from the *Tools* menu (Figure *Activation of the Plugin functionality from the Tools menu* in [Plugins](#plugins) section).



??? où ça mène plugins ici ?
