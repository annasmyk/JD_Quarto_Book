...
-   (Statistical) Algorithms available via plug-ins
...
+=======================================================================================================+=========================================+=============================+
| X12+                                                                                                  | jdplus-x12plus-desktop-plugin-x.y.z.nbm | Usage in GUI described here |
|                                                                                                       |                                         |                             |
| Airline based pre-adjustment and extended X11 decomposition                                           |                                         |                             |
+-------------------------------------------------------------------------------------------------------+-----------------------------------------+-----------------------------+
| STL+                                                                                                  | jdplus-stl-desktop-plugin-x.y.z.nbm     | Usage in GUI described here |
|                                                                                                       |                                         |                             |
| Airline based pre-adjustment and STL (Loess) decomposition                                            |                                         |                             |
+-------------------------------------------------------------------------------------------------------+-----------------------------------------+-----------------------------+
| STS+                                                                                                  | jdplus-sts-desktop-plugin-x.y.z.nbm     | Usage in GUI described here |
|                                                                                                       |                                         |                             |
...
-   [ConCur](https://bbkrd.github.io/pages/concur): The plug-in ConCur supports the controlled current adjustment approach. It pro the storage of the current components and offers graphical tools to compare forecasted and re-estimated figures. Furthermore, a pre-defined summary of the output containing the most important quality measures can be exported to HTML files.
