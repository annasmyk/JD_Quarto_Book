...
## Algorithms available with plug-ins

Here is an overview of the algorithms or features which can be added by installing additional (vs main) plug-ins to the Graphical User Interface listed by functionality. For all the mentioned files corresponding to number of version is denoted x.y.z.
...
- Denton 
- Cholette (including Multi-variate)
- Calendarization 

Temporal Dia

The plug-in file is available [here](https://github.com/nbbrd/jdemetra-benchmarking) for download. Usage in GUI is described in [this chapter](#a-bench)


### Data base access (SDMX)
...
## Plug-ins documentation for version 2.x

The sections below provide more detailed explanations and link to documentation pages external to this book for plug-ins compatible with JDemetra+ 2.x.
