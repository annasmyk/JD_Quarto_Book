...
Full documentation of `RJDemetra::regarima()`{.r} function can be found [here](https://jdemetra.github.io/rjdemetra/reference/regarima.html)

Full documentation of `RJDemetra::regarima_tramoseats()`{.r} function can be found [here](https://jdemetra.github.io/rjdemetra/reference/regarima.html)
