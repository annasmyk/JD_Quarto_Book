...
Open R to find and install the **rjd3bench** package and see its documentation pages.

See below how to perform Benchmarking and Temporal Disaggregation methods, once the package is installed.
