...
These methods provide a high-frequency series, introducing a low frequency series (input series), applying a regression model that relates the input series with p auxiliar series (proxy). 
