...
After a first estimation, raw data has been modified (extended and/or revised) and the user wants to update SA estimation keeping fixed. The set of constraints on the parameters is called "revision policy" or "refresh policy".


## Revision policies in GUI

The saved results from a seasonal adjustment processing can be
