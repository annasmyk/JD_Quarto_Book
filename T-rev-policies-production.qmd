...
concurrent = first estimation 
or redo everutything (never overrides user defined parameters)

## Implementing revision policies in GUI
...
built in function only in v3
(cf estp adv + alain's bug)
