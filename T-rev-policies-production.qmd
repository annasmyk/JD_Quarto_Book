...
Raw data has been modified (extended and/or revised) and the previous SA estimation needs updating, but with keeping certain parameters fixed. The set of constraints on the parameters is called "revision policy" or "refresh policy".
