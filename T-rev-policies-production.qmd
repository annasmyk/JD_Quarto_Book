# Production and revision policies {.unnumbered #t-rev-pol}
...
- refreshing a workspace with rjdemetra3
...
Available policies and names are detailed in [here](#t-rev-pol-ov). 

More explanations and full documentation of 

- `rjd3x13::x13_refresh` function can be found [here](https://rjdemetra.github.io/rjd3x13/reference/refresh.html)

-  ``rjd3tramoseats::tramoseats_refresh` function can be found [here](https://rjdemetra.github.io/rjd3tramoseats/reference/refresh.html)
