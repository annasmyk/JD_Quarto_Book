...
In a seasonal adjustment estimation or reg-arima modelling outliers are detected by default. This process can be customized by selected the type of outliers to be taken into account and the critical values to be used for selection. See the relevant chapters on [SA](A-sa.qmd) and [SA of High-frequency data](A-sa-hf.qmd)
