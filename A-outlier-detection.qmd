...
How to use the generated regressors, or any user-defined variable, in a seasonal adjustment or reg-arima modelling process is discussed in the relevant chapters on [SA](A-sa.qmd) and [SA of High-frequency data](A-sa-hf.qmd). There you will also find out how to fix the corresponding coefficients and how to allocate the effects to selected component.
