...
This chapter will provide a contextualized overview of new features of v 3.x  as well as modification of display or content for existing features. Compared to its predecessor, version 3.x provides:

-   Additional Algorithms for SA, Benchmarking, Nowcasting, Revision Analysis
...
These functions are in `rjd3providers` and  `rjdemetra3` packages, (already in a v 2.x stable precursor `rjdworkspace`)
...
![Canova Hansen seasonality FB_Canova.pngges/FB_Canova.png){width=250px}
