...
- high frequency data (extended features) linked to M-sa-hf.qmd chapter 
...
The X-11 program is the result of a long tradition of non-parametric smoothing based on moving averages.
...
To better understand this steps, some concepts on moving averages (MA) are necessary
...
the first cleaning of the series done using the Reg-ARIMA facilities:
