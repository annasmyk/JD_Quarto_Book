...
To overcome these flaws first the series are modelled with a Reg-ARIMA model that removes deterministic effects (calendar, outliers) and computes forecasts.
