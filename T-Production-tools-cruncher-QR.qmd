...
-   JDCruncheR package: download the **.zip** or **.tar.gz** file from <https://github.com/InseeFr/JDCruncheR/releases> or install the package from github:
...
```{r, eval = FALSE}
options(cruncher_bin_directory = "C:/Software/jwsacruncher-2.2.3/jdemetra-cli-2.2.3/bin")
```
...
- other argument you can find [here](https://aqlt.github.io/rjwsacruncher/reference/create_param_file.html)
