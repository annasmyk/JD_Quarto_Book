...
Practical guidance on how to use these algorithms can be found [here](#part-A), whereas detailed description of all the available tools allowing to access the algorithms can be found in the [Tools](#part-T) part of this book.
