...
(deatils will go to calendar chapter)
...
intervention variables 
 ...
 - **Intervention variables**<br> *regression variables; --*
   ...
   The intervention variables are defined as in TSW+. Following the definition, these effects are special events known a priori (strikes, devaluations, political events, and so on). Intervention variables are modeled as any possible sequence of ones and zeros, on which some operators may be applied. Intervention variables are built as combinations of the following basic structures[^16]: 
   *  Dummy variables[^17];
