...
Default specifications are set for the whole SA procedure, pre-treatment end decomposition. They are slightly different for X13-ARIMA and Tramo-Seats and can be modified with user defined parameters.
...
![](All_images/SA_REGA_retrieve_calendar_options_details.png)

#### Setting options

#### **In GUI** Use the specification window

![](All_images/SA_REGA_calendar_setting.png)
