...
Hint at GUI chap for global principles
- ws structure (new SAP)
- global specification handling 
...
here national calendars not taken into accout

set this option GUI specif detail 
...
out of calendars and outliers 
warning : calendars won't be allocated to calendars, if not...
...
Context : here in put is spcified (auto or user)
focus on global model estimation
...
Modifiying specifications for Arima model 
GUI 
...
(all GUI based analysis)
NODES below bechamrking
