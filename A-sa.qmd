...
(see Maruman for new outline)
(see aux txt file for param def)

#### Default specifications

Options related to calendar regressors choice are embedded into default specifications described above. National calendars are not taken into account.
