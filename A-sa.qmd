...
capture pane with 3 variables: interv, ramp and user defined 

pb: I cannot add user-defined when already ramp and interv 
...
- modify automatic detection parametrs 
...
SA_REGA_Arima_user_params_1.png
