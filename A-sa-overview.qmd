...
-   [SA with Basic Structural Models (BSM)](#a-sa-bsm)
...
X13-ARIMA and TRAMO-SEATS are two-step algorithms with a pre-treatment phase (Reg-Arima or Tramo) and a decomposition phase (X11 and Seats). STL is a local regression (Loess) based decomposition, origibwithout pre-treatment. but...
...
Full documentation of those functions can be found [here](https://rjdemetra.github.io/rjd3toolkit/reference/index.html)
