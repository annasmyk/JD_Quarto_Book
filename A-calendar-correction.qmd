...
att : calendar regressors by frequency, wht is available
...
- step 3: these regressors have to be plugged-in in pre-adjustment phase of a seasonal adjustment estimation. How to do this is detailed in chapters on [SA](A-sa.qmd) or [SA of HF data](A-sa-hf.qmd).

How to add other types of regressors is described [here](A-outlier-detection.qmd)
