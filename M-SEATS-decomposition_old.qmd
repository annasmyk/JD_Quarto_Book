...
The function $\widetilde{\nu}(\omega)$ is also referred as the gain of the filter.[^m-seats-decomposition_old-17] GÓMEZ, V., and MARAVALL, A. (2001a) show that when for some frequency the signal (the seasonally adjusted series) dominates the noise (seasonal fluctuations) the gain $\widetilde{\nu}(\omega)$ approaches 1. On the contrary, when for some frequency the noise dominates the gain $\widetilde{\nu}(\omega)$ approaches 0.

[^m-seats-decomposition_old-17]: GÓMEZ, V., and MARAVALL, A. (2001a).
