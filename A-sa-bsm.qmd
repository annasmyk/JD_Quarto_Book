...
We will cover how to perform seasonal adjustment using BSM in JDemetra+. How to tackling multiple periodicities (with rounded frequencies) in infra-monthly data will be described in the [high-frequency]((#a-sa-hf)) data related chapter.  
