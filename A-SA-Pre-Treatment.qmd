...
## Reallocation of pre-treatment effect {#sa-pre-t-realloc}

## Pre-treatment: Reg-Arima or Tramo {#pre-pro-spec}

The following sections cover how to perform pre-treatment with Reg-ARIMA (or Tramo) algorithms. Tramo and the Reg-Arima part of X13-ARIMA rely on very similar principles: [Reg-Arima modelling](M-reg-arima-modelling.qmd). Thus Tramo will be mentioned only to highlight differences with the Reg-Arima part of X13-ARIMA. Reg-Arima modelling part can be of a seasonal adjustment process or run on its own, we focus on performing pre-treatment as part of a SA processing.
...
=======
![**Setting in GUI**](All_images/SA_REGA_arima_auto_params_v2.png)
>>>>>>> 1a4297f10d537c24c1f7a2d238407c52058a2c4f

#### v3

![**Setting in GUI**](All_images/SA_REGA_arima_auto_params_v3.png)
