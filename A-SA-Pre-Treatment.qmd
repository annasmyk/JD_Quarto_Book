...
- The linearised series will be decomposed into unobservable components in the decomposition phase

$$y_{lin} =S_{lin} +T_{lin}+I_{lin}$$


- Pre-treatment effects will then be reallocated to build the final components
